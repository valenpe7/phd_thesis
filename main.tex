...
Since the first demonstration of pulsed laser by T. H. Maiman in 1960 [Maiman, 1960], the fields of optics and laser technology have seen a tremendous progress. The introduction of Q-switching [Hellwarth, 1961] and mode-locking [Mocker and Collins, 1965] enabled a rapid increase in laser intensities and decrease in laser pulse durations. At the same time, the major effects in nonlinear optics, such as the generation of optical harmonics (Franken, 1961), optical rectification (Bass, 1962), optical Kerr effect (Phys. Rev. 127, 1918, 1962; Phys. Rev. Lett. 12, 507, 1964), stimulated Raman scattering (Woodbury and Ng, 1962), stimulated Brilouin scattering (Chiao, Garmire, and Townes, 1964; Chiao, Townes, and Stoicheff, 1964), and multiphoton ionization (Voronov and Delone, 1965; Agostini et al., 1968) were discovered. In 1985, G. Mourou and D. Strickland invented chirped pulse amplification (CPA) [Mourou and Strickland, 1985], a technique for 
...
The petawatt ($ \mathrm{PW} $) threshold was exceeded at the end of 20th century (Perry et al. 1999).

Currently, the record power is for the ELI Nuclear Physics 10PW laser (Tanaka et al. 2020), with another 10PW laser near completion in ELI-Beamlies.

Current worldwide activities on PW laser systems and further envisions to attain > 100PW lasers are summarized in (Danson et al. 2019; Li et al. 2021).
