...
In this Chapter, we first present a brief overview of history and the latest technological achievements of laser - our main instrument. Then, we , we also what role the author play. Finally, we outline how the structure of this doctoral thesis is organized.
...
The relativistic flying mirrors, ...
...
As a first goal of our work, we

In this chapter, we aim at closer description of several innovative laser-based schemes for producing accelerated electron beams in plasmas. 

novel schemes

for quite a broad range of laser-plasma parameters,  

we reveal that, when the laser pulse parameters are not ideally matched to the parameters plasma, intense ring-shaped laser filaments arise. These electromagnetic ring-shaped structures become a source of high-energy electron rings.

One of the most promising concepts is the laser plasma acceleration, where the particles are accelerated by strong electromagnetic fields generated by laser pulses in plasma. 

In particular, laser driven acceleration of electrons has made quite an impressive progress from 1979, when it was proposed [8], to 2020 when 7.8-GeV beam was accelerated by a PW-class laser in the plasma channel [9, 10] (see also [11, 12]). 

Laser-wakefield acceleration is a promising concept for the acceleration 

This pawes a way towards a new generation of compact electron accelerators.

%In order to reach this regime, the laser pulse must have transverse and longitudinal size comparable with the plasma wavelength and its intensity must be sufficiently high to expel all the electrons from the vicinity of the propagation axis. 
