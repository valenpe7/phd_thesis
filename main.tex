...
Experimental implementation of the tight-focusing scheme by a parabola with f-number, $ f_N $, (the ratio of the focal length, $ f $, to the beam diameter, $ D $) of 0.6 claims focusing of a 45 TW laser to a $ \approx 0.8 \mu m $ focal spot diameter, leading to an intensity of $ \approx 10^{22} W / cm^2 $ (Bahk et al. 2004), where a similar intensity is achieved by focusing a 0.3PW using a parabola of fN = 1.3 (Pirozhkov et al. 2017).
