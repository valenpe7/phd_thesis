...
Let us here describe the propagation of electromagnetic and finite-amplitude (i.e., the frequency of the wave depends on the amplitude) Langmuir (electrostatic) waves in cold collisionless plasma. The exact solution to this problem was first found in Ref.~\citenum{Akhiezer1956}.
...
\end{equation}
where $ C \leq 1 $. For alternatives to the standard finite-difference time-domain method, the reader can refer to, e.g., Refs.~\citenum{Cole1997, Liu1997, Pukhov1999, Cowan2013, Lehe2013, Vay2013, Vincenti2016}.
...
\end{aligned}
\end{equation}
According to Ref.~\citenum{Esirkepov2001}, only one linear combination of the eight functions, Eq.~(\ref{eq:current_density_deposition_functions}), satisfies the conditions imposed on $ \vec{W} $,
...
First, we present the results of research devoted to the coupled electromagnetic and electron rings originating from the interaction of a high-power short-pulse laser and underdense plasma, which have been published in Ref.~\ref{paper_1} (the reader can find the full text of the paper in Appendix~\ref{sec:paper_1}). This research has been initiated after the experimental observation of stable and tunable ring-shaped beams of high-energy electrons; the experiment has been carried out by the ELI Beamlines Electron Acceleration Group at the Institute of Plasma Physics and Laser Microfusion in Warsaw, Poland (the reader can find further details in Ref.~\citenum{Grittani2018}). Our preliminary goal was to find out and describe the underlying physical mechanisms that lead to the formation of ring-shaped electron beams in laser plasmas. Although several processes that may result in the electron rings of similar parameters were already identified and presented in the literature at that time (see, e.g., Refs.~\citenum{Kaganovich2008, Zhang2012, Pollock2015, Zhao2016, Yang2017, Behm2019, Salehi2021}), none of them seemed to correspond to the particular experimental parameters used in Ref.~\citenum{Grittani2018}.
...
Apart from the applications of attosecond x-ray pulses mentioned in Sec.~\ref{sec:on_the_recoil_effects_of_relativistic_mirrors}, the scheme described in Ref.~\ref{paper_4} provides an additional tool in laser-plasma diagnostics for probing relativistic plasma singularities by a transverse source pulse, as suggested in Ref.~\citenum{Esirkepov2020}. One of the immediate applications of such a diagnostic is control and tuning of the burst intensification by singularity emitting radiation \cite{Pirozhkov2012, Pirozhkov2014, Pirozhkov2017, Pirozhkov2018, Sagisaka2020}, which occurs with the same parameters for the driver laser and plasma as required by the described scheme. The optical probing of relativistic plasma singularities could also reveal a phenomenon similar to the Lampa-Penrose-Terrell effect \cite{Lampa1924, Penrose1959, Terrell1959}, i.e., the image of the constellation of density singularities in plasma would be such as if the singularities were slightly rotated with respect to each other (see Ref.~\citenum{Esirkepov2020} for closer details).

%helping to analyze the dynamics of nonlinear physical processes in relativistic plasmas. 

%The peculiar spectrum of the reflected radiation in this scheme, using the head-on collision of the driver and source, substantially extends the capabilities for probing relativistic plasma singularities by a transverse source pulse, as suggested in Ref.~\citenum{Esirkepov2020}. 

%Using a weak and short laser pulse as a probe, one can deduce or characterize the parameters of the laser-plasma interaction, including the geometrical properties of the first period of the plasma wave (wake wave cavity and bow wave), driver pulse frequency and magnitude at the location of the mirror, the phase velocity of the wake wave, the electron temperature and momentum distribution at the location of the mirror, etc. 

%so that off-axis radiation from the mirror can be observed simultaneously with near- or on-axis BISER. 

%In addition to the fundamental physics concerning intense laser-plasma interactions, plasma diagnostics with the described scheme may help to substantially improve the quality of the laser pulse by revealing what laser parameters are the most critical. Such investigations, in the example of the laser pulse quality effects on the BISER realization, were conducted recently \cite{}. That work revealed some critical parameters of the laser pulse which have to be improved to obtain good results and scalings predicted by theory. 

%Last but not least, optical probing of relativistic plasma singularities could reveal a phenomenon similar to the Lampa-Penrose-Terrell effect \cite{Lampa1924, Penrose1959, Terrell1959}, i.e., the image of the constellation of density singularities in plasma would be such as if the singularities were slightly rotated with respect to each other (for closer details see Ref.~\citenum{Esirkepov2020}).
...
Throughout my postgraduate studies, I have had the privilege to meet and work with a number of highly skilled and inspiring people. In the next few paragraphs, I would like to express my deepest gratitude to these people, and to all the other people who have supported me while writing this thesis and especially while carrying out the work that this thesis presents.

First and foremost, I would like to express my sincere gratitude and appreciation to Prof. Sergei Bulanov, not only for giving me the opportunity to join his research group at ELI Beamlines, but also for being a truly exceptional person and an absolute professional in literally every aspect. Without your continual support, guidance, patience, and immense knowledge, the research presented in this thesis and the valuable skills I have learned throughout would have not been possible. 

Second, I would like to thank Dr. Ondřej Klimo for introducing me to this fascinating field of science and for always being around ready to help and solve problems ever since early in my undergraduate studies. Through your leadership and positive motivation you have enabled me to build my own scientific career and to grow both personally and professionally.

As an integral part of my postgraduate education, I had an opportunity to visit and work at two world-class research institutes. I take this occasion to thank Prof. Pisin Chen, his assistant Yen-Ling, and his students Yung-Kun and Yuan, for organizing my stay at Leung Center for Cosmology and Particle Astrophysics, Taipei, Taiwan with ease and efficiency and for their wonderful hospitality. I am equally thankful to Prof. Tetsuya Kawachi, Dr. Timur Esirkepov, Dr. Satoshi Orimo, Dr. James Koga, Dr. Alexander Pirozhkov, and Dr. Masaki Kando for hosting me ... I would particularly like to single out Timur Esirkepov and Tetsuya Kawachi to whom I am especially grateful, for taking care of me and for passionate introduction to Japanese history, culture, language, and cuisine.



for helping me begin this
journey and encouraging me throughout. You have consistently challenged me to push
my boundaries and you have enabled me to grow in ways that I could never imagine.
Thank you for teaching me to explore the world through my eyes and urging me to take
greater responsibility for overcoming obstacles.
...
to grow into an outstanding team

and giving me a substantial amount of freedom and responsibility during my scientific activity build my own scientific career.

enabled me to build my own scientific career




 -- Leung Center for Cosmology and Particle Astrophysics, Taipei, Taiwan and Kansai Photon Science Institute, Kyoto, Japan.  


... I take this occasion to thankI am thankful to Prof. Tetsuya Kawachi, Dr. Timur Esirkepov, Dr. Satoshi Orimo, Dr. James Koga, Dr. Alexander Pirozhkov, and Dr. Masaki Kando for their. I would particularly like to single out Timur, to who I am especially grateful, for being so patient with me,

My special thanks belong to Dr. Timur Esirkepov who introducing me the Japan history, culture, and cuisine
...
organizing my visit
 ...
 wonderful hospitality during my stay there
...
absolute professional in virtually every way

has always impressed me and struck me as something to strive for.

I would now like to take this opportunity to express my deepest gratitude to these and all the other people that have contributed to making this thesis possible.

Your knowledge, enthusiasm
and creativity has been an constant source of inspiration for me. Without
your guidance and insight I would not be where I am today.


Throughout my postgraduate studies I have received a great deal of support and assistance. 

 I have had the privilege to meet and work with a number of highly skilled and influential people.

During the course of my PhD I have had the privilege to meet and work
with a number of highly skilled and inuential people. I would now like to
take this opportunity to express my deepest gratitude to these and all the
other people that have contributed to making this thesis possible.

In the next few paragraphs I would like to acknowledge the people that have supported me while writing this thesis and especially while carrying out the work that this thesis presents. 

 



Last but not least I wish to express my gratitude to my friends and
family.

since back my undergraduate studies.

for his enthusiasm and the interesting and enlightening discussions

for his generous help from the very beginning \\
