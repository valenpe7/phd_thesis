...
{\Large \bf \ctu} \\
{\Large \bf \fnspe} \\[16mm]
\epsfysize=40mm \epsffile{img/logo/ctu.pdf}\\[16mm]
...
\chapter*{Abstrakt\markboth{Abstract}{Abstract}}
%\addcontentsline{toc}{chapter}{Abstract}
\thispagestyle{empty}

Tato práce se zabývá vývojem zdrojů urychlených elektronů a koherentního krátkovlnného záření, převážně v rentgenovém spektru energie fotonů, založených na interakci vysokovýkonných laserů s plazmatem. Využíváme metodu urychlování elektronů laserem řízeným brázdovým polem a relativistické zrcadla, které významně závisí na řízené excitaci Langmuirových vln o vysokých amplitudách v podkritickém plazmatu. Tato témata studujeme pomocí teoretické práce a rozsáhlých numerických simulací založených na metodě particle-in-cell.

Co se týče zdrojů urychlených eletronů, práce obsahuje popis nových fyzikálních mechanismů vedoucích ke vzniku elektromagnetických a elektronových prstenců a objev periodického přepólování brázdového pole v případě vybuzení ultrakrátkým laserovým svazkem v plazmatu o téměř kritické hustotě. V případě zdrojů krátkovlnného záření, práce popisuje jevy zpětného rázu působící na relativistické zrcadlo při odrazu laserového svazku a návrh nového schématu pro fyzickou realizaci relativistického zrcadla založený na hustotních singularitách v podkritickém plazmatu.
...
We investigate sources of high-energy electron beams and coherent short-wavelength radiation, predominantly in the x-ray range of photon energies, using the interaction of high-power laser with plasma. We employ the concepts of the laser-wakefield acceleration and relativistic flying mirrors which both strongly rely on controlled generation of large-amplitude Langmuir waves in underdense plasma. We study these topics using theoretical work and large-scale numerical simulations based on the particle-in-cell method. 

Regarding the sources of electrons, we describe novel physical mechanisms which lead to the formation of ring-shaped electromagnetic-electron structures and reveal that the wakefield excited by an ultrashort laser pulse in near-critical density plasma periodically reverses its polarity. Regarding the sources of coherent short-wavelength radiation, we describe the recoil effects on the laser pulse reflection from relativistic flying mirrors and propose a novel scheme for physical realization of relativistic flying mirrors based on the electron density singularities in underdense plasma. \\
...
% unit vector, norm, grad, laplace, N natural, Z whole, R real numbers
%The symbol $ \nabla = \left( \diffp{}/{x_1}, \diffp{}/{x_2}, \diffp{}/{x_3} \right) $ and $ \laplace = \nabla^2 $. 
