...
derived in the approximation of a weak incident electromagnetic wave.
...
\end{equation}
\end{subequations}
Here $ \mathcal{N}_e $ and $ \mathcal{N}_{\omega} $ are the numbers of interacting electrons and photons, respectively. The electron and photon momenta and energies can be expressed as
\begin{subequations}
...
\begin{subequations}
\begin{equation}\label{eq:}
\frac{\omega_0^{\prime \prime}}{\omega_0} \approx 4 \gamma^2 \quad \mathrm{for} \quad \mathcal{R} \mathcal{N}_{\omega} \hbar \omega_0 \ll \frac{\mathcal{N}_e m_e c^2}{4 \gamma} 
\end{equation}
\begin{equation}\label{eq:}
\frac{\omega_0^{\prime \prime}}{\omega_0} \approx \frac{\mathcal{N}_e m_e c^2 \gamma}{\mathcal{R} \mathcal{N}_{\omega} \hbar  \omega_0} \quad \mathrm{for} \quad \mathcal{R} \mathcal{N}_{\omega} \hbar \omega_0 \gg \frac{\mathcal{N}_e m_e c^2}{4 \gamma} 
\end{equation}
\end{subequations}
