...
%\begin{chapquote}{Aristotle (384 BC - 322 BC)}
...
\begin{savequote}[0.5\linewidth]
	\q{There is nothing more practical than a good theory.}
	\qauthor{-- Gustav Kirchhoff (1824 -- 1887)}
\end{savequote}
...
\begin{savequote}[0.5\linewidth]
	...
	\qauthor{-- Edward Teller (1908 -- 2003)}
\end{savequote}
